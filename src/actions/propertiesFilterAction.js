...
export const vacantPlotFilter = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/rent/vacantPlots?page=1&limit=10"
    );
...
export const vacantPlotFilterSale = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/sale/vacantPlots?page=1&limit=10"
    );
...
export const warehouseFilter = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/rent/warehouse?page=1&limit=10"
    );
...
export const warehouseFiltersale = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/sale/warehouse?page=1&limit=10"
    );
...
export const commercialFilter = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/rent/commercial?page=1&limit=10"
    );
...
export const commercialFilterSale = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/sale/commercial?page=1&limit=10"
    );
...
export const apartmentsFilter = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/rent/apartments?page=1&limit=10"
    )
...
export const apartmentsFilterSale = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/sale/apartments?page=1&limit=10"
    );
...
export const residentialsFilter = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/rent/residential?page=1&limit=10"
    );
...
export const residentialsFilterSale = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/sale/residential?page=1&limit=10"
    );
...
export const officesFilter = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/rent/offices?page=1&limit=10"
    );
...
export const officesFilterSale = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      "https://quickhouse-436caeb406a0.herokuapp.com/api/properties/sale/offices?page=1&limit=10"
    );
