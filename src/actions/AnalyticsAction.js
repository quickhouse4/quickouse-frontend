...
export const getDataAnalytic = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/viewsAnalytics", {
            headers: {
                token: token
            }
        })
...
export const getYearViews = (token, year) => async (dispatch) => {
    try {
        ...
        const response = await axios.get(`http://197.243.26.162/api/viewsAnalytics?yearData=${year}`, {
            headers: {
                token: token
            }
        })
...
export const getYearLikes = (token, year) => async (dispatch) => {
    try {
        ...
        const response = await axios.get(`http://197.243.26.162/api/likes?yearData=${year}`, {
            headers: {
                token: token
            }
        })
...
export const getLikeAnalytic = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/likes", {
            headers: {
                token: token
            }
        })
...
export const getPostNumber = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/myPosts", {
            headers: {
                token: token
            }
        })
...
export const getLikeNumber = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/allLikes", {
            headers: {
                token: token
            }
        })
...
export const getViewsNumber = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/myViews", {
            headers: {
                token: token
            }
        });
...
export const getPlotNumber = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/posts/plot", {
            headers: {
                token: token
            }
        });
...
export const getHouseNumber = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/posts/house", {
            headers: {
                token: token
            }
        });
...
export const getRentPosts = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/posts/forRent", {
            headers: {
                token: token
            }
        });
...
export const getSalePosts = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api//posts/forSale", {
            headers: {
                token: token
            }
        });
...
export const getTotalPosts = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/posts", {
            headers: {
                token: token
            }
        });
...
export const getTotalViews = (token) => async (dispatch) => {
    try {
        ...
        const response = await axios.get("http://197.243.26.162/api/totalViews", {
            headers: {
                token: token
            }
        });
...
export const visitorsTrack = () => async (dispatch) => {
    try {
        ...
        const response = await axios.post("http://197.243.26.162/api/visits");
        dispatch({
...
export const getVisitorAnalytics = (token, year) => async (dispatch) => {
    try {
        ...
        const response = await axios.get(`http://197.243.26.162/api/analyticsVisits?yearData=${year}`, {
            headers: {
                token: token
            }
        });
...
export const getTotalViewAnalytics = (year) => async (dispatch) => {
    try {
        ...
        const response = await axios.get(`http://197.243.26.162/api/totalAnalyticsViews?yearData=${year}`);
        dispatch({
...
export const getTotalLikeAnalytics = (year) => async (dispatch) => {
    try {
        ...
        const response = await axios.get(`http://197.243.26.162/api/totalAnalyticsLikes?yearData=${year}`);
        dispatch({
